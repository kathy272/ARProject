...
# options: -q -O2 -IC:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders -IC:/Users/blender/git/blender-v420/blender.git/lib/windows_x64/osl/share/OSL/shaders -o C:/Users/blender/git/blender-v420/build_release/intern/cycles/kernel/osl/shaders/node_gradient_texture.oso
...
code Vector
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_gradient_texture.osl:54
#     point Vector = P,
	assign		Vector P 	%filename{"C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_gradient_texture.osl"} %line{54} %argrw{"wr"}
code ___main___
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_gradient_texture.osl:58
#   point p = Vector;
	assign		p Vector 	%filename{"C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_gradient_texture.osl"} %line{58} %argrw{"wr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_gradient_texture.osl:60
#   if (use_mapping)
	if		use_mapping 4 4 	%line{60} %argrw{"r"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_gradient_texture.osl:61
#     p = transform(mapping, p);
	transform	p mapping p 	%line{61} %argrw{"wrr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_gradient_texture.osl:63
#   Fac = gradient(p, gradient_type);
	functioncall	$const1 51 	%line{63} %argrw{"r"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_gradient_texture.osl:13
#   x = p[0];
	compref		___362_x p $const2 	%line{13} %argrw{"wrr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_gradient_texture.osl:14
#   y = p[1];
	compref		___362_y p $const3 	%line{14} %argrw{"wrr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_gradient_texture.osl:15
#   z = p[2];
	compref		___362_z p $const4 	%line{15} %argrw{"wrr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_gradient_texture.osl:17
#   float result = 0.0;
	assign		___362_result $const5 	%line{17} %argrw{"wr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_gradient_texture.osl:19
#   if (type == "linear") {
	eq		$tmp1 gradient_type $const6 	%line{19} %argrw{"wrr"}
	if		$tmp1 12 48 	%argrw{"r"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_gradient_texture.osl:20
#     result = x;
	assign		___362_result ___362_x 	%line{20} %argrw{"wr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_gradient_texture.osl:22
#   else if (type == "quadratic") {
	eq		$tmp2 gradient_type $const7 	%line{22} %argrw{"wrr"}
	if		$tmp2 16 48 	%argrw{"r"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_gradient_texture.osl:23
#     float r = max(x, 0.0);
	max		___364_r ___362_x $const5 	%line{23} %argrw{"wrr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_gradient_texture.osl:24
#     result = r * r;
	mul		___362_result ___364_r ___364_r 	%line{24} %argrw{"wrr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_gradient_texture.osl:26
#   else if (type == "easing") {
	eq		$tmp3 gradient_type $const8 	%line{26} %argrw{"wrr"}
	if		$tmp3 25 48 	%argrw{"r"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_gradient_texture.osl:27
#     float r = min(max(x, 0.0), 1.0);
	max		$tmp4 ___362_x $const5 	%line{27} %argrw{"wrr"}
	min		___365_r $tmp4 $const9 	%argrw{"wrr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_gradient_texture.osl:28
#     float t = r * r;
	mul		___365_t ___365_r ___365_r 	%line{28} %argrw{"wrr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_gradient_texture.osl:30
...
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_gradient_texture.osl:32
#   else if (type == "diagonal") {
	eq		$tmp8 gradient_type $const12 	%line{32} %argrw{"wrr"}
	if		$tmp8 29 48 	%argrw{"r"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_gradient_texture.osl:33
#     result = (x + y) * 0.5;
	add		$tmp9 ___362_x ___362_y 	%line{33} %argrw{"wrr"}
	mul		___362_result $tmp9 $const13 	%argrw{"wrr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_gradient_texture.osl:35
#   else if (type == "radial") {
	eq		$tmp10 gradient_type $const14 	%line{35} %argrw{"wrr"}
	if		$tmp10 34 48 	%argrw{"r"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_gradient_texture.osl:36
...
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_gradient_texture.osl:39
...
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_gradient_texture.osl:41
#     if (type == "quadratic_sphere")
	eq		$tmp20 gradient_type $const16 	%line{41} %argrw{"wrr"}
	if		$tmp20 45 48 	%argrw{"r"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_gradient_texture.osl:42
#       result = r * r;
	mul		___362_result ___368_r ___368_r 	%line{42} %argrw{"wrr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_gradient_texture.osl:43
#     else if (type == "spherical")
	eq		$tmp21 gradient_type $const17 	%line{43} %argrw{"wrr"}
	if		$tmp21 48 48 	%argrw{"r"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_gradient_texture.osl:44
#       result = r;
	assign		___362_result ___368_r 	%line{44} %argrw{"wr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_gradient_texture.osl:47
...
# float  clamp (float x, float minval, float maxval) { return max(min(x,maxval),minval); }
	min		$tmp22 ___362_result $const9 	%filename{"C:/Users/blender/git/blender-v420/blender.git/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{141} %argrw{"wrr"}
	max		Fac $tmp22 $const5 	%argrw{"wrr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_gradient_texture.osl:64
#   Color = color(Fac, Fac, Fac);
	color		Color Fac Fac Fac 	%filename{"C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_gradient_texture.osl"} %line{64} %argrw{"wrrr"}
	end
