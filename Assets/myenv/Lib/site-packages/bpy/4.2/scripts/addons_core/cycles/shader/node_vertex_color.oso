...
# options: -q -O2 -IC:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders -IC:/Users/blender/git/blender-v420/blender.git/lib/windows_x64/osl/share/OSL/shaders -o C:/Users/blender/git/blender-v420/build_release/intern/cycles/kernel/osl/shaders/node_vertex_color.oso
...
code ___main___
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vertex_color.osl:15
#   if (layer_name == "") {
	eq		$tmp1 layer_name $const1 	%filename{"C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vertex_color.osl"} %line{15} %argrw{"wrr"}
	if		$tmp1 3 4 	%argrw{"r"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vertex_color.osl:16
#     vertex_color_layer = "geom:vertex_color";
	assign		vertex_color_layer $const2 	%line{16} %argrw{"wr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vertex_color.osl:19
#     vertex_color_layer = layer_name;
	assign		vertex_color_layer layer_name 	%line{19} %argrw{"wr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vertex_color.osl:22
...
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vertex_color.osl:23
...
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vertex_color.osl:24
#     Alpha = vertex_color[3];
	aref		Alpha vertex_color $const6 	%line{24} %argrw{"wrr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vertex_color.osl:26
#     if (bump_offset == "dx") {
	eq		$tmp6 bump_offset $const7 	%line{26} %argrw{"wrr"}
	if		$tmp6 17 23 	%argrw{"r"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vertex_color.osl:27
#       Color += Dx(Color);
	Dx		$tmp7 Color 	%line{27} %argrw{"wr"} %argderivs{1}
	add		Color Color $tmp7 	%argrw{"wrr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vertex_color.osl:28
#       Alpha += Dx(Alpha);
	Dx		$tmp8 Alpha 	%line{28} %argrw{"wr"} %argderivs{1}
	add		Alpha Alpha $tmp8 	%argrw{"wrr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vertex_color.osl:30
#     else if (bump_offset == "dy") {
	eq		$tmp9 bump_offset $const8 	%line{30} %argrw{"wrr"}
	if		$tmp9 23 23 	%argrw{"r"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vertex_color.osl:31
#       Color += Dy(Color);
	Dy		$tmp10 Color 	%line{31} %argrw{"wr"} %argderivs{1}
	add		Color Color $tmp10 	%argrw{"wrr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vertex_color.osl:32
#       Alpha += Dy(Alpha);
	Dy		$tmp11 Alpha 	%line{32} %argrw{"wr"} %argderivs{1}
	add		Alpha Alpha $tmp11 	%argrw{"wrr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vertex_color.osl:36
