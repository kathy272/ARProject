...
# options: -q -O2 -IC:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders -IC:/Users/blender/git/blender-v420/blender.git/lib/windows_x64/osl/share/OSL/shaders -o C:/Users/blender/git/blender-v420/build_release/intern/cycles/kernel/osl/shaders/node_ies_light.oso
...
code Vector
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_ies_light.osl:13
#                       point Vector = I,
	assign		Vector I 	%filename{"C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_ies_light.osl"} %line{13} %argrw{"wr"}
code ___main___
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_ies_light.osl:16
#   point p = Vector;
	assign		p Vector 	%filename{"C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_ies_light.osl"} %line{16} %argrw{"wr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_ies_light.osl:18
#   if (use_mapping) {
	if		use_mapping 4 4 	%line{18} %argrw{"r"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_ies_light.osl:19
#     p = transform(mapping, p);
	transform	p mapping p 	%line{19} %argrw{"wrr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_ies_light.osl:22
#   p = normalize((vector)p);
	normalize	p p 	%line{22} %argrw{"wr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_ies_light.osl:24
#   float v_angle = acos(-p[2]);
	compref		$tmp1 p $const1 	%line{24} %argrw{"wrr"}
	neg		$tmp2 $tmp1 	%argrw{"wr"}
	acos		v_angle $tmp2 	%argrw{"wr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_ies_light.osl:25
...
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_ies_light.osl:27
