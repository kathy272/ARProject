...
# options: -q -O2 -IC:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders -IC:/Users/blender/git/blender-v420/blender.git/lib/windows_x64/osl/share/OSL/shaders -o C:/Users/blender/git/blender-v420/build_release/intern/cycles/kernel/osl/shaders/node_bump.oso
surface node_bump
...
code NormalIn
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_bump.osl:12
#                   normal NormalIn = N,
	assign		NormalIn N 	%filename{"C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_bump.osl"} %line{12} %argrw{"wr"}
code NormalOut
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_bump.osl:18
#                   output normal NormalOut = N)
	assign		NormalOut N 	%filename{"C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_bump.osl"} %line{18} %argrw{"wr"}
code ___main___
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_bump.osl:20
#   point Ptmp = P;
	assign		Ptmp P 	%filename{"C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_bump.osl"} %line{20} %argrw{"wr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_bump.osl:21
#   normal Normal = NormalIn;
	assign		Normal NormalIn 	%line{21} %argrw{"wr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_bump.osl:23
#   if (use_object_space) {
	if		use_object_space 10 10 	%line{23} %argrw{"r"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_bump.osl:24
...
# point  transform (string to, point p)  { return transform("common",to,p); }
	transform	Ptmp $const3 $const1 Ptmp 	%filename{"C:/Users/blender/git/blender-v420/blender.git/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{263} %argrw{"wrrr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_bump.osl:25
#     Normal = normalize(transform("object", Normal));
	functioncall	$const2 9 	%filename{"C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_bump.osl"} %line{25} %argrw{"r"}
# C:/Users/blender/git/blender-v420/blender.git/lib/windows_x64/osl/share/OSL/shaders/stdosl.h:261
# normal transform (string to, normal p) { return transform("common",to,p); }
	transformn	$tmp1 $const3 $const1 Normal 	%filename{"C:/Users/blender/git/blender-v420/blender.git/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{261} %argrw{"wrrr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_bump.osl:25
#     Normal = normalize(transform("object", Normal));
	normalize	Normal $tmp1 	%filename{"C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_bump.osl"} %line{25} %argrw{"wr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_bump.osl:29
#   vector dPdx = Dx(Ptmp);
	Dx		dPdx Ptmp 	%line{29} %argrw{"wr"} %argderivs{1}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_bump.osl:30
#   vector dPdy = Dy(Ptmp);
	Dy		dPdy Ptmp 	%line{30} %argrw{"wr"} %argderivs{1}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_bump.osl:32
#   vector Rx = cross(dPdy, Normal);
	cross		Rx dPdy Normal 	%line{32} %argrw{"wrr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_bump.osl:33
#   vector Ry = cross(Normal, dPdx);
	cross		Ry Normal dPdx 	%line{33} %argrw{"wrr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_bump.osl:36
#   float det = dot(dPdx, Rx);
	dot		det dPdx Rx 	%line{36} %argrw{"wrr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_bump.osl:37
...
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_bump.osl:39
#   float absdet = fabs(det);
	fabs		absdet det 	%line{39} %argrw{"wr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_bump.osl:41
#   float strength = max(Strength, 0.0);
	max		strength Strength $const4 	%line{41} %argrw{"wrr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_bump.osl:42
#   float dist = Distance;
	assign		dist Distance 	%line{42} %argrw{"wr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_bump.osl:44
#   if (invert)
	if		invert 25 25 	%line{44} %argrw{"r"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_bump.osl:45
#     dist *= -1.0;
	mul		dist dist $const5 	%line{45} %argrw{"wrr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_bump.osl:48
...
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_bump.osl:49
...
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_bump.osl:51
#   if (use_object_space) {
	if		use_object_space 39 39 	%line{51} %argrw{"r"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_bump.osl:52
