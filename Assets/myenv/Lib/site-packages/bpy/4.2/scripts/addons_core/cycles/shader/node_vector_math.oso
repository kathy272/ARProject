...
# options: -q -O2 -IC:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders -IC:/Users/blender/git/blender-v420/blender.git/lib/windows_x64/osl/share/OSL/shaders -o C:/Users/blender/git/blender-v420/build_release/intern/cycles/kernel/osl/shaders/node_vector_math.oso
...
code ___main___
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vector_math.osl:16
#   if (math_type == "add") {
	eq		$tmp1 math_type $const1 	%filename{"C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vector_math.osl"} %line{16} %argrw{"wrr"}
	if		$tmp1 3 212 	%argrw{"r"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vector_math.osl:17
#     Vector = Vector1 + Vector2;
	add		Vector Vector1 Vector2 	%line{17} %argrw{"wrr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vector_math.osl:19
#   else if (math_type == "subtract") {
	eq		$tmp2 math_type $const2 	%line{19} %argrw{"wrr"}
	if		$tmp2 6 212 	%argrw{"r"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vector_math.osl:20
#     Vector = Vector1 - Vector2;
	sub		Vector Vector1 Vector2 	%line{20} %argrw{"wrr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vector_math.osl:22
#   else if (math_type == "multiply") {
	eq		$tmp3 math_type $const3 	%line{22} %argrw{"wrr"}
	if		$tmp3 9 212 	%argrw{"r"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vector_math.osl:23
#     Vector = Vector1 * Vector2;
	mul		Vector Vector1 Vector2 	%line{23} %argrw{"wrr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vector_math.osl:25
#   else if (math_type == "divide") {
	eq		$tmp4 math_type $const4 	%line{25} %argrw{"wrr"}
	if		$tmp4 35 212 	%argrw{"r"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vector_math.osl:26
...
#   return vector((b[0] != 0.0) ? a[0] / b[0] : 0.0,
	compref		$tmp6 Vector2 $const6 	%filename{"C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders\\node_math.h"} %line{12} %argrw{"wrr"}
...
#                 (b[2] != 0.0) ? a[2] / b[2] : 0.0);
	return	%line{14}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vector_math.osl:28
#   else if (math_type == "cross_product") {
	eq		$tmp20 math_type $const10 	%filename{"C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vector_math.osl"} %line{28} %argrw{"wrr"}
	if		$tmp20 38 212 	%argrw{"r"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vector_math.osl:29
#     Vector = cross(Vector1, Vector2);
	cross		Vector Vector1 Vector2 	%line{29} %argrw{"wrr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vector_math.osl:31
#   else if (math_type == "project") {
	eq		$tmp21 math_type $const11 	%line{31} %argrw{"wrr"}
	if		$tmp21 49 212 	%argrw{"r"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vector_math.osl:32
#     Vector = project(Vector1, Vector2);
	functioncall	$const11 49 	%line{32} %argrw{"r"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders\\node_math.h:61
#   float lenSquared = dot(v_proj, v_proj);
	dot		___355_lenSquared Vector2 Vector2 	%filename{"C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders\\node_math.h"} %line{61} %argrw{"wrr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders\\node_math.h:62
#   return (lenSquared != 0.0) ? (dot(v, v_proj) / lenSquared) * v_proj : vector(0.0);
	...
	return
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vector_math.osl:34
#   else if (math_type == "reflect") {
	eq		$tmp25 math_type $const13 	%filename{"C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vector_math.osl"} %line{34} %argrw{"wrr"}
	if		$tmp25 57 212 	%argrw{"r"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vector_math.osl:35
#     Vector = reflect(Vector1, normalize(Vector2));
	normalize	$tmp26 Vector2 	%line{35} %argrw{"wr"}
	functioncall	$const13 57 	%argrw{"r"}
# C:/Users/blender/git/blender-v420/blender.git/lib/windows_x64/osl/share/OSL/shaders/stdosl.h:212
# vector reflect (vector I, vector N) { return I - 2*dot(N,I)*N; }
	dot		$tmp27 $tmp26 Vector1 	%filename{"C:/Users/blender/git/blender-v420/blender.git/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{212} %argrw{"wrr"}
	mul		$tmp28 $const14 $tmp27 	%argrw{"wrr"}
	mul		$tmp29 $tmp28 $tmp26 	%argrw{"wrr"}
	sub		Vector Vector1 $tmp29 	%argrw{"wrr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vector_math.osl:37
#   else if (math_type == "refract") {
	eq		$tmp30 math_type $const15 	%filename{"C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vector_math.osl"} %line{37} %argrw{"wrr"}
	if		$tmp30 77 212 	%argrw{"r"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vector_math.osl:38
#     Vector = refract(Vector1, normalize(Vector2), Scale);
	normalize	$tmp31 Vector2 	%line{38} %argrw{"wr"}
	functioncall	$const15 77 	%argrw{"r"}
# C:/Users/blender/git/blender-v420/blender.git/lib/windows_x64/osl/share/OSL/shaders/stdosl.h:214
#     float IdotN = dot (I, N);
	dot		___240_IdotN Vector1 $tmp31 	%filename{"C:/Users/blender/git/blender-v420/blender.git/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{214} %argrw{"wrr"}
# C:/Users/blender/git/blender-v420/blender.git/lib/windows_x64/osl/share/OSL/shaders/stdosl.h:215
...
# C:/Users/blender/git/blender-v420/blender.git/lib/windows_x64/osl/share/OSL/shaders/stdosl.h:216
#     return (k < 0) ? vector(0,0,0) : (eta*I - N * (eta*IdotN + sqrt(k)));
	...
	return
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vector_math.osl:40
#   else if (math_type == "faceforward") {
	eq		$tmp42 math_type $const17 	%filename{"C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vector_math.osl"} %line{40} %argrw{"wrr"}
	if		$tmp42 86 212 	%argrw{"r"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vector_math.osl:41
...
#   return dot(reference, incident) < 0.0 ? vec : -vec;
	dot		$tmp43 Vector3 Vector2 	%filename{"C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders\\node_math.h"} %line{88} %argrw{"wrr"}
	lt		$tmp44 $tmp43 $const7 	%argrw{"wrr"}
	if		$tmp44 84 85 	%argrw{"r"}
	assign		Vector Vector1 	%argrw{"wr"}
	neg		Vector Vector1 	%argrw{"wr"}
	return
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vector_math.osl:43
#   else if (math_type == "multiply_add") {
	eq		$tmp45 math_type $const19 	%filename{"C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vector_math.osl"} %line{43} %argrw{"wrr"}
	if		$tmp45 90 212 	%argrw{"r"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vector_math.osl:44
#     Vector = Vector1 * Vector2 + Vector3;
	mul		$tmp46 Vector1 Vector2 	%line{44} %argrw{"wrr"}
	add		Vector $tmp46 Vector3 	%argrw{"wrr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vector_math.osl:46
#   else if (math_type == "dot_product") {
	eq		$tmp47 math_type $const20 	%line{46} %argrw{"wrr"}
	if		$tmp47 93 212 	%argrw{"r"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vector_math.osl:47
#     Value = dot(Vector1, Vector2);
	dot		Value Vector1 Vector2 	%line{47} %argrw{"wrr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vector_math.osl:49
#   else if (math_type == "distance") {
	eq		$tmp48 math_type $const21 	%line{49} %argrw{"wrr"}
	if		$tmp48 96 212 	%argrw{"r"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vector_math.osl:50
#     Value = distance(Vector1, Vector2);
	distance	Value Vector1 Vector2 	%line{50} %argrw{"wrr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vector_math.osl:52
#   else if (math_type == "length") {
	eq		$tmp49 math_type $const22 	%line{52} %argrw{"wrr"}
	if		$tmp49 99 212 	%argrw{"r"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vector_math.osl:53
#     Value = length(Vector1);
	length		Value Vector1 	%line{53} %argrw{"wr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vector_math.osl:55
#   else if (math_type == "scale") {
	eq		$tmp50 math_type $const23 	%line{55} %argrw{"wrr"}
	if		$tmp50 102 212 	%argrw{"r"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vector_math.osl:56
#     Vector = Vector1 * Scale;
	mul		Vector Vector1 Scale 	%line{56} %argrw{"wrr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vector_math.osl:58
#   else if (math_type == "normalize") {
	eq		$tmp51 math_type $const24 	%line{58} %argrw{"wrr"}
	if		$tmp51 105 212 	%argrw{"r"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vector_math.osl:59
#     Vector = normalize(Vector1);
	normalize	Vector Vector1 	%line{59} %argrw{"wr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vector_math.osl:61
#   else if (math_type == "snap") {
	eq		$tmp52 math_type $const25 	%line{61} %argrw{"wrr"}
	if		$tmp52 134 212 	%argrw{"r"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vector_math.osl:62
#     Vector = snap(Vector1, Vector2);
	functioncall	$const25 134 	%line{62} %argrw{"r"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders\\node_math.h:67
#   return floor(safe_divide(a, b)) * b;
	functioncall	$const5 132 	%filename{"C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders\\node_math.h"} %line{67} %argrw{"r"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders\\node_math.h:12
#   return vector((b[0] != 0.0) ? a[0] / b[0] : 0.0,
...
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vector_math.osl:64
#   else if (math_type == "floor") {
	eq		$tmp70 math_type $const26 	%filename{"C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vector_math.osl"} %line{64} %argrw{"wrr"}
	if		$tmp70 137 212 	%argrw{"r"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vector_math.osl:65
#     Vector = floor(Vector1);
	floor		Vector Vector1 	%line{65} %argrw{"wr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vector_math.osl:67
#   else if (math_type == "ceil") {
	eq		$tmp71 math_type $const27 	%line{67} %argrw{"wrr"}
	if		$tmp71 140 212 	%argrw{"r"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vector_math.osl:68
#     Vector = ceil(Vector1);
	ceil		Vector Vector1 	%line{68} %argrw{"wr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vector_math.osl:70
#   else if (math_type == "modulo") {
	eq		$tmp72 math_type $const28 	%line{70} %argrw{"wrr"}
	if		$tmp72 143 212 	%argrw{"r"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vector_math.osl:71
#     Vector = fmod(Vector1, Vector2);
	fmod		Vector Vector1 Vector2 	%line{71} %argrw{"wrr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vector_math.osl:73
#   else if (math_type == "wrap") {
	eq		$tmp73 math_type $const29 	%line{73} %argrw{"wrr"}
	if		$tmp73 189 212 	%argrw{"r"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vector_math.osl:74
#     Vector = wrap(Vector1, Vector2, Vector3);
	functioncall	$const29 189 	%line{74} %argrw{"r"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders\\node_math.h:79
#   return point(wrap(value[0], max[0], min[0]),
	compref		$tmp75 Vector1 $const6 	%filename{"C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders\\node_math.h"} %line{79} %argrw{"wrr"}
...
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vector_math.osl:76
#   else if (math_type == "fraction") {
	eq		$tmp101 math_type $const30 	%filename{"C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vector_math.osl"} %line{76} %argrw{"wrr"}
	if		$tmp101 193 212 	%argrw{"r"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vector_math.osl:77
#     Vector = Vector1 - floor(Vector1);
	floor		$tmp102 Vector1 	%line{77} %argrw{"wr"}
	sub		Vector Vector1 $tmp102 	%argrw{"wrr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vector_math.osl:79
#   else if (math_type == "absolute") {
	eq		$tmp103 math_type $const31 	%line{79} %argrw{"wrr"}
	if		$tmp103 196 212 	%argrw{"r"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vector_math.osl:80
#     Vector = abs(Vector1);
	abs		Vector Vector1 	%line{80} %argrw{"wr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vector_math.osl:82
#   else if (math_type == "minimum") {
	eq		$tmp104 math_type $const32 	%line{82} %argrw{"wrr"}
	if		$tmp104 199 212 	%argrw{"r"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vector_math.osl:83
#     Vector = min(Vector1, Vector2);
	min		Vector Vector1 Vector2 	%line{83} %argrw{"wrr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vector_math.osl:85
#   else if (math_type == "maximum") {
	eq		$tmp105 math_type $const33 	%line{85} %argrw{"wrr"}
	if		$tmp105 202 212 	%argrw{"r"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vector_math.osl:86
#     Vector = max(Vector1, Vector2);
	max		Vector Vector1 Vector2 	%line{86} %argrw{"wrr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vector_math.osl:88
#   else if (math_type == "sine") {
	eq		$tmp106 math_type $const34 	%line{88} %argrw{"wrr"}
	if		$tmp106 205 212 	%argrw{"r"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vector_math.osl:89
#     Vector = sin(Vector1);
	sin		Vector Vector1 	%line{89} %argrw{"wr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vector_math.osl:91
#   else if (math_type == "cosine") {
	eq		$tmp107 math_type $const35 	%line{91} %argrw{"wrr"}
	if		$tmp107 208 212 	%argrw{"r"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vector_math.osl:92
#     Vector = cos(Vector1);
	cos		Vector Vector1 	%line{92} %argrw{"wr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vector_math.osl:94
#   else if (math_type == "tangent") {
	eq		$tmp108 math_type $const36 	%line{94} %argrw{"wrr"}
	if		$tmp108 211 212 	%argrw{"r"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vector_math.osl:95
#     Vector = tan(Vector1);
	tan		Vector Vector1 	%line{95} %argrw{"wr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vector_math.osl:98
