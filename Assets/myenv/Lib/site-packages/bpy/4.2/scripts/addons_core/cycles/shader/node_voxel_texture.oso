...
# options: -q -O2 -IC:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders -IC:/Users/blender/git/blender-v420/blender.git/lib/windows_x64/osl/share/OSL/shaders -o C:/Users/blender/git/blender-v420/build_release/intern/cycles/kernel/osl/shaders/node_voxel_texture.oso
...
code Vector
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_voxel_texture.osl:11
#                           point Vector = P,
	assign		Vector P 	%filename{"C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_voxel_texture.osl"} %line{11} %argrw{"wr"}
code ___main___
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_voxel_texture.osl:15
#   point p = Vector;
	assign		p Vector 	%filename{"C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_voxel_texture.osl"} %line{15} %argrw{"wr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_voxel_texture.osl:16
#   if (use_mapping) {
	if		use_mapping 4 9 	%line{16} %argrw{"r"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_voxel_texture.osl:17
#     p = transform(mapping, p);
	transform	p mapping p 	%line{17} %argrw{"wrr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_voxel_texture.osl:20
...
# point  transform (string to, point p)  { return transform("common",to,p); }
	transform	p $const3 $const1 Vector 	%filename{"C:/Users/blender/git/blender-v420/blender.git/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{263} %argrw{"wrrr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_voxel_texture.osl:22
#     if (getattribute("geom:generated_transform", tfm))
	getattribute	$tmp1 $const4 ___363_tfm 	%filename{"C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_voxel_texture.osl"} %line{22} %argrw{"wrw"}
	if		$tmp1 9 9 	%argrw{"r"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_voxel_texture.osl:23
#       p = transform(tfm, p);
	transform	p ___363_tfm p 	%line{23} %argrw{"wrr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_voxel_texture.osl:25
...
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_voxel_texture.osl:26
#     Density = 0;
	assign		Density $const5 	%line{26} %argrw{"wr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_voxel_texture.osl:27
#     Color = color(0, 0, 0);
	assign		Color $const10 	%line{27} %argrw{"wr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_voxel_texture.osl:30
