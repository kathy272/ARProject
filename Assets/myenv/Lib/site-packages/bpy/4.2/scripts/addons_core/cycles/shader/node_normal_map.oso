...
# options: -q -O2 -IC:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders -IC:/Users/blender/git/blender-v420/blender.git/lib/windows_x64/osl/share/OSL/shaders -o C:/Users/blender/git/blender-v420/build_release/intern/cycles/kernel/osl/shaders/node_normal_map.oso
...
code Normal
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_normal_map.osl:12
#                        output normal Normal = N)
	assign		Normal N 	%filename{"C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_normal_map.osl"} %line{12} %argrw{"wr"}
code ___main___
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_normal_map.osl:14
#   color mcolor = 2.0 * color(Color[0] - 0.5, Color[1] - 0.5, Color[2] - 0.5);
	compref		$tmp2 Color $const2 	%filename{"C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_normal_map.osl"} %line{14} %argrw{"wrr"}
...
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_normal_map.osl:15
#   int is_backfacing = backfacing();
	backfacing	is_backfacing 	%line{15} %argrw{"w"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_normal_map.osl:17
#   if (space == "tangent") {
	eq		$tmp8 space $const6 	%line{17} %argrw{"wrr"}
	if		$tmp8 63 93 	%argrw{"r"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_normal_map.osl:21
#     float is_smooth = 0.0;
	assign		___362_is_smooth $const7 	%line{21} %argrw{"wr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_normal_map.osl:23
#     getattribute("geom:is_smooth", is_smooth);
	getattribute	$tmp9 $const8 ___362_is_smooth 	%line{23} %argrw{"wrw"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_normal_map.osl:24
#     if (!is_smooth) {
	eq		$tmp10 ___362_is_smooth $const7 	%line{24} %argrw{"wrr"}
	if		$tmp10 20 20 	%argrw{"r"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_normal_map.osl:25
...
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_normal_map.osl:28
#       if (is_backfacing) {
	if		is_backfacing 20 20 	%line{28} %argrw{"r"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_normal_map.osl:29
#         ninterp = -ninterp;
	neg		___362_ninterp ___362_ninterp 	%line{29} %argrw{"wr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_normal_map.osl:34
...
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_normal_map.osl:35
...
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_normal_map.osl:38
#       vector B = tangent_sign * cross(ninterp, tangent);
	cross		$tmp22 ___362_ninterp ___362_tangent 	%line{38} %argrw{"wrr"}
	mul		___365_B ___362_tangent_sign $tmp22 	%argrw{"wrr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_normal_map.osl:41
#       mcolor[0] *= Strength;
	compref		$tmp23 mcolor $const2 	%line{41} %argrw{"wrr"}
	mul		$tmp24 $tmp23 Strength 	%argrw{"wrr"}
	compassign	mcolor $const2 $tmp24 	%argrw{"wrr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_normal_map.osl:42
#       mcolor[1] *= Strength;
	compref		$tmp25 mcolor $const4 	%line{42} %argrw{"wrr"}
	mul		$tmp26 $tmp25 Strength 	%argrw{"wrr"}
	compassign	mcolor $const4 $tmp26 	%argrw{"wrr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_normal_map.osl:43
...
# float  clamp (float x, float minval, float maxval) { return max(min(x,maxval),minval); }
	min		$tmp30 Strength $const12 	%filename{"C:/Users/blender/git/blender-v420/blender.git/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{141} %argrw{"wrr"}
	max		$tmp29 $tmp30 $const7 	%argrw{"wrr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_normal_map.osl:43
#       mcolor[2] = mix(1.0, mcolor[2], clamp(Strength, 0.0, 1.0));
	mix		$tmp27 $const12 $tmp28 $tmp29 	%filename{"C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_normal_map.osl"} %line{43} %argrw{"wrrr"}
	compassign	mcolor $const5 $tmp27 	%argrw{"wrr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_normal_map.osl:45
...
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_normal_map.osl:48
#       Normal = normalize(transform("object", "world", Normal));
	transformn	$tmp39 $const10 $const9 Normal 	%line{48} %argrw{"wrrr"}
	normalize	Normal $tmp39 	%argrw{"wr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_normal_map.osl:51
#       Normal = normal(0, 0, 0);
	assign		Normal $const14 	%line{51} %argrw{"wr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_normal_map.osl:54
#   else if (space == "object") {
	eq		$tmp40 space $const10 	%line{54} %argrw{"wrr"}
	if		$tmp40 68 93 	%argrw{"r"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_normal_map.osl:55
...
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_normal_map.osl:57
#   else if (space == "world") {
	eq		$tmp43 space $const9 	%line{57} %argrw{"wrr"}
	if		$tmp43 72 93 	%argrw{"r"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_normal_map.osl:58
#     Normal = normalize(vector(mcolor));
	assign		$tmp44 mcolor 	%line{58} %argrw{"wr"}
	normalize	Normal $tmp44 	%argrw{"wr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_normal_map.osl:60
#   else if (space == "blender_object") {
	eq		$tmp45 space $const15 	%line{60} %argrw{"wrr"}
	if		$tmp45 83 93 	%argrw{"r"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_normal_map.osl:62
#     mcolor[1] = -mcolor[1];
	compref		$tmp46 mcolor $const4 	%line{62} %argrw{"wrr"}
	neg		$tmp47 $tmp46 	%argrw{"wr"}
	compassign	mcolor $const4 $tmp47 	%argrw{"wrr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_normal_map.osl:63
#     mcolor[2] = -mcolor[2];
	compref		$tmp48 mcolor $const5 	%line{63} %argrw{"wrr"}
	neg		$tmp49 $tmp48 	%argrw{"wr"}
	compassign	mcolor $const5 $tmp49 	%argrw{"wrr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_normal_map.osl:65
#     Normal = normalize(transform("object", "world", vector(mcolor)));
	assign		$tmp51 mcolor 	%line{65} %argrw{"wr"}
	transformv	$tmp50 $const10 $const9 $tmp51 	%argrw{"wrrr"}
	normalize	Normal $tmp50 	%argrw{"wr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_normal_map.osl:67
#   else if (space == "blender_world") {
	eq		$tmp52 space $const16 	%line{67} %argrw{"wrr"}
	if		$tmp52 93 93 	%argrw{"r"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_normal_map.osl:69
#     mcolor[1] = -mcolor[1];
	compref		$tmp53 mcolor $const4 	%line{69} %argrw{"wrr"}
	neg		$tmp54 $tmp53 	%argrw{"wr"}
	compassign	mcolor $const4 $tmp54 	%argrw{"wrr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_normal_map.osl:70
#     mcolor[2] = -mcolor[2];
	compref		$tmp55 mcolor $const5 	%line{70} %argrw{"wrr"}
	neg		$tmp56 $tmp55 	%argrw{"wr"}
	compassign	mcolor $const5 $tmp56 	%argrw{"wrr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_normal_map.osl:72
#     Normal = normalize(vector(mcolor));
	assign		$tmp57 mcolor 	%line{72} %argrw{"wr"}
	normalize	Normal $tmp57 	%argrw{"wr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_normal_map.osl:76
#   if (is_backfacing) {
	if		is_backfacing 95 95 	%line{76} %argrw{"r"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_normal_map.osl:77
#     Normal = -Normal;
	neg		Normal Normal 	%line{77} %argrw{"wr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_normal_map.osl:80
...
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_normal_map.osl:81
