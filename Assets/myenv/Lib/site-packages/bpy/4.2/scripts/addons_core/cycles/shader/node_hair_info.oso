...
# options: -q -O2 -IC:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders -IC:/Users/blender/git/blender-v420/blender.git/lib/windows_x64/osl/share/OSL/shaders -o C:/Users/blender/git/blender-v420/build_release/intern/cycles/kernel/osl/shaders/node_hair_info.oso
...
code TangentNormal
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_hair_info.osl:11
#                       output normal TangentNormal = N,
	assign		TangentNormal N 	%filename{"C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_hair_info.osl"} %line{11} %argrw{"wr"}
code ___main___
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_hair_info.osl:14
#   getattribute("geom:is_curve", IsStrand);
	getattribute	$tmp1 $const1 IsStrand 	%filename{"C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_hair_info.osl"} %line{14} %argrw{"wrw"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_hair_info.osl:15
#   getattribute("geom:curve_intercept", Intercept);
	getattribute	$tmp2 $const2 Intercept 	%line{15} %argrw{"wrw"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_hair_info.osl:16
#   getattribute("geom:curve_length", Length);
	getattribute	$tmp3 $const3 Length 	%line{16} %argrw{"wrw"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_hair_info.osl:17
#   getattribute("geom:curve_thickness", Thickness);
	getattribute	$tmp4 $const4 Thickness 	%line{17} %argrw{"wrw"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_hair_info.osl:18
#   getattribute("geom:curve_tangent_normal", TangentNormal);
	getattribute	$tmp5 $const5 TangentNormal 	%line{18} %argrw{"wrw"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_hair_info.osl:19
