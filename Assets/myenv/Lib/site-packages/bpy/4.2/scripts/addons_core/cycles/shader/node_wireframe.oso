...
# options: -q -O2 -IC:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders -IC:/Users/blender/git/blender-v420/blender.git/lib/windows_x64/osl/share/OSL/shaders -o C:/Users/blender/git/blender-v420/build_release/intern/cycles/kernel/osl/shaders/node_wireframe.oso
...
code ___main___
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_wireframe.osl:13
#   Fac = wireframe("triangles", Size, use_pixel_size);
	functioncall	$const2 75 	%filename{"C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_wireframe.osl"} %line{13} %argrw{"r"}
# C:/Users/blender/git/blender-v420/blender.git/lib/windows_x64/osl/share/OSL/shaders\\oslutil.h:16
#    if (raytype("path:diffuse")) return 0.0;
	raytype		$tmp1 $const3 	%filename{"C:/Users/blender/git/blender-v420/blender.git/lib/windows_x64/osl/share/OSL/shaders\\oslutil.h"} %line{16} %argrw{"wr"}
	if		$tmp1 5 5 	%argrw{"r"}
	assign		Fac $const4 	%argrw{"wr"}
	return
# C:/Users/blender/git/blender-v420/blender.git/lib/windows_x64/osl/share/OSL/shaders\\oslutil.h:18
#    int np = 0;
	assign		___344_np $const5 	%line{18} %argrw{"wr"}
# C:/Users/blender/git/blender-v420/blender.git/lib/windows_x64/osl/share/OSL/shaders\\oslutil.h:20
#    float pixelWidth = 1;
	assign		___344_pixelWidth $const6 	%line{20} %argrw{"wr"}
# C:/Users/blender/git/blender-v420/blender.git/lib/windows_x64/osl/share/OSL/shaders\\oslutil.h:22
#    if (edge_type == "triangles")
	eq		$tmp2 $const1 $const1 	%line{22} %argrw{"wrr"}
	if		$tmp2 15 33 	%argrw{"r"}
# C:/Users/blender/git/blender-v420/blender.git/lib/windows_x64/osl/share/OSL/shaders\\oslutil.h:24
#       np = 3;
	assign		___344_np $const7 	%line{24} %argrw{"wr"}
# C:/Users/blender/git/blender-v420/blender.git/lib/windows_x64/osl/share/OSL/shaders\\oslutil.h:25
...
# C:/Users/blender/git/blender-v420/blender.git/lib/windows_x64/osl/share/OSL/shaders\\oslutil.h:26
#          return 0.0;
	assign		Fac $const4 	%line{26} %argrw{"wr"}
	return
# C:/Users/blender/git/blender-v420/blender.git/lib/windows_x64/osl/share/OSL/shaders\\oslutil.h:28
...
# C:/Users/blender/git/blender-v420/blender.git/lib/windows_x64/osl/share/OSL/shaders\\oslutil.h:30
#       getattribute("geom:numpolyvertices", np);
	getattribute	$tmp9 $const11 ___344_np 	%line{30} %argrw{"wrw"}
# C:/Users/blender/git/blender-v420/blender.git/lib/windows_x64/osl/share/OSL/shaders\\oslutil.h:31
...
# C:/Users/blender/git/blender-v420/blender.git/lib/windows_x64/osl/share/OSL/shaders\\oslutil.h:32
#          return 0.0;
	assign		Fac $const4 	%line{32} %argrw{"wr"}
	return
# C:/Users/blender/git/blender-v420/blender.git/lib/windows_x64/osl/share/OSL/shaders\\oslutil.h:35
#    if (raster)
	if		use_pixel_size 48 48 	%line{35} %argrw{"r"}
# C:/Users/blender/git/blender-v420/blender.git/lib/windows_x64/osl/share/OSL/shaders\\oslutil.h:39
...
# C:/Users/blender/git/blender-v420/blender.git/lib/windows_x64/osl/share/OSL/shaders\\oslutil.h:40
...
# C:/Users/blender/git/blender-v420/blender.git/lib/windows_x64/osl/share/OSL/shaders\\oslutil.h:42
...
# C:/Users/blender/git/blender-v420/blender.git/lib/windows_x64/osl/share/OSL/shaders\\oslutil.h:47
#    pixelWidth *= 0.5 * line_width;
	mul		$tmp26 $const15 Size 	%line{47} %argrw{"wrr"}
	mul		___344_pixelWidth ___344_pixelWidth $tmp26 	%argrw{"wrr"}
# C:/Users/blender/git/blender-v420/blender.git/lib/windows_x64/osl/share/OSL/shaders\\oslutil.h:48
#    pixelWidth *= pixelWidth;
	mul		___344_pixelWidth ___344_pixelWidth ___344_pixelWidth 	%line{48} %argrw{"wrr"}
# C:/Users/blender/git/blender-v420/blender.git/lib/windows_x64/osl/share/OSL/shaders\\oslutil.h:49
#    for (int i = 0; i < np; i++)
...
# C:/Users/blender/git/blender-v420/blender.git/lib/windows_x64/osl/share/OSL/shaders\\oslutil.h:51
#       int i2 = i ? i - 1 : np - 1;
	if		___348_i 57 58 	%line{51} %argrw{"r"}
	sub		___349_i2 ___348_i $const6 	%argrw{"wrr"}
	sub		___349_i2 ___344_np $const6 	%argrw{"wrr"}
# C:/Users/blender/git/blender-v420/blender.git/lib/windows_x64/osl/share/OSL/shaders\\oslutil.h:52
#       vector dir = P - p[i];
	aref		$tmp29 ___344_p ___348_i 	%line{52} %argrw{"wrr"}
	sub		___349_dir P $tmp29 	%argrw{"wrr"}
# C:/Users/blender/git/blender-v420/blender.git/lib/windows_x64/osl/share/OSL/shaders\\oslutil.h:53
...
# C:/Users/blender/git/blender-v420/blender.git/lib/windows_x64/osl/share/OSL/shaders\\oslutil.h:54
#       vector crs = cross(edge, dir);
	cross		___349_crs ___349_edge ___349_dir 	%line{54} %argrw{"wrr"}
# C:/Users/blender/git/blender-v420/blender.git/lib/windows_x64/osl/share/OSL/shaders\\oslutil.h:58
...
# C:/Users/blender/git/blender-v420/blender.git/lib/windows_x64/osl/share/OSL/shaders\\oslutil.h:59
#          return 1;
...
# C:/Users/blender/git/blender-v420/blender.git/lib/windows_x64/osl/share/OSL/shaders\\oslutil.h:61
#    return 0;
	assign		Fac $const5 	%line{61} %argrw{"wr"}
	return
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_wireframe.osl:18
#   if (bump_offset == "dx") {
	eq		$tmp37 bump_offset $const16 	%filename{"C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_wireframe.osl"} %line{18} %argrw{"wrr"}
	if		$tmp37 158 241 	%argrw{"r"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_wireframe.osl:19
#     point dx = Dx(P);
	Dx		___374_dx P 	%line{19} %argrw{"wr"} %argderivs{1}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_wireframe.osl:20
#     P -= dx;
	sub		P P ___374_dx 	%line{20} %argrw{"wrr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_wireframe.osl:21
#     Fac += (Fac - wireframe("triangles", Size, use_pixel_size)) / length(dx);
	functioncall	$const2 154 	%line{21} %argrw{"r"}
# C:/Users/blender/git/blender-v420/blender.git/lib/windows_x64/osl/share/OSL/shaders\\oslutil.h:16
#    if (raytype("path:diffuse")) return 0.0;
	raytype		$tmp39 $const3 	%filename{"C:/Users/blender/git/blender-v420/blender.git/lib/windows_x64/osl/share/OSL/shaders\\oslutil.h"} %line{16} %argrw{"wr"}
...
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_wireframe.osl:21
#     Fac += (Fac - wireframe("triangles", Size, use_pixel_size)) / length(dx);
	sub		$tmp75 Fac $tmp38 	%filename{"C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_wireframe.osl"} %line{21} %argrw{"wrr"}
	length		$tmp76 ___374_dx 	%argrw{"wr"}
	div		$tmp77 $tmp75 $tmp76 	%argrw{"wrr"}
	add		Fac Fac $tmp77 	%argrw{"wrr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_wireframe.osl:23
#   else if (bump_offset == "dy") {
	eq		$tmp78 bump_offset $const17 	%line{23} %argrw{"wrr"}
	if		$tmp78 241 241 	%argrw{"r"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_wireframe.osl:24
#     point dy = Dy(P);
	Dy		___375_dy P 	%line{24} %argrw{"wr"} %argderivs{1}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_wireframe.osl:25
#     P -= dy;
	sub		P P ___375_dy 	%line{25} %argrw{"wrr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_wireframe.osl:26
#     Fac += (Fac - wireframe("triangles", Size, use_pixel_size)) / length(dy);
	functioncall	$const2 237 	%line{26} %argrw{"r"}
# C:/Users/blender/git/blender-v420/blender.git/lib/windows_x64/osl/share/OSL/shaders\\oslutil.h:16
#    if (raytype("path:diffuse")) return 0.0;
	raytype		$tmp80 $const3 	%filename{"C:/Users/blender/git/blender-v420/blender.git/lib/windows_x64/osl/share/OSL/shaders\\oslutil.h"} %line{16} %argrw{"wr"}
...
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_wireframe.osl:26
#     Fac += (Fac - wireframe("triangles", Size, use_pixel_size)) / length(dy);
	sub		$tmp116 Fac $tmp79 	%filename{"C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_wireframe.osl"} %line{26} %argrw{"wrr"}
