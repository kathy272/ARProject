...
# options: -q -O2 -IC:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders -IC:/Users/blender/git/blender-v420/blender.git/lib/windows_x64/osl/share/OSL/shaders -o C:/Users/blender/git/blender-v420/build_release/intern/cycles/kernel/osl/shaders/node_vector_map_range.oso
...
code ___main___
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vector_map_range.osl:27
#   point factor = VectorIn;
	assign		factor VectorIn 	%filename{"C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vector_map_range.osl"} %line{27} %argrw{"wr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vector_map_range.osl:28
#   point from_min = From_Min_FLOAT3;
	assign		from_min From_Min_FLOAT3 	%line{28} %argrw{"wr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vector_map_range.osl:29
#   point from_max = From_Max_FLOAT3;
	assign		from_max From_Max_FLOAT3 	%line{29} %argrw{"wr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vector_map_range.osl:30
#   point to_min = To_Min_FLOAT3;
	assign		to_min To_Min_FLOAT3 	%line{30} %argrw{"wr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vector_map_range.osl:31
#   point to_max = To_Max_FLOAT3;
	assign		to_max To_Max_FLOAT3 	%line{31} %argrw{"wr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vector_map_range.osl:32
#   point steps = Steps_FLOAT3;
	assign		steps Steps_FLOAT3 	%line{32} %argrw{"wr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vector_map_range.osl:34
#   if (range_type == "stepped") {
	eq		$tmp1 range_type $const1 	%line{34} %argrw{"wrr"}
	if		$tmp1 70 179 	%argrw{"r"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vector_map_range.osl:35
...
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vector_map_range.osl:14
...
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vector_map_range.osl:9
...
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vector_map_range.osl:36
...
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vector_map_range.osl:37
...
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vector_map_range.osl:38
...
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vector_map_range.osl:40
#   else if (range_type == "smoothstep") {
	eq		$tmp43 range_type $const8 	%line{40} %argrw{"wrr"}
	if		$tmp43 109 179 	%argrw{"r"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vector_map_range.osl:41
#     factor = safe_divide((factor - from_min), (from_max - from_min));
...
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vector_map_range.osl:42
#     factor = clamp(factor, 0.0, 1.0);
	assign		$tmp58 $const4 	%line{42} %argrw{"wr"}
	assign		$tmp59 $const7 	%argrw{"wr"}
	functioncall	$const9 105 	%argrw{"r"}
# C:/Users/blender/git/blender-v420/blender.git/lib/windows_x64/osl/share/OSL/shaders/stdosl.h:139
# point  clamp (point x, point minval, point maxval) { return max(min(x,maxval),minval); }
	min		$tmp60 factor $tmp59 	%filename{"C:/Users/blender/git/blender-v420/blender.git/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{139} %argrw{"wrr"}
	max		factor $tmp60 $tmp58 	%argrw{"wrr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vector_map_range.osl:43
#     factor = (3.0 - 2.0 * factor) * (factor * factor);
	mul		$tmp61 $const11 factor 	%filename{"C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vector_map_range.osl"} %line{43} %argrw{"wrr"}
	sub		$tmp62 $const10 $tmp61 	%argrw{"wrr"}
	mul		$tmp63 factor factor 	%argrw{"wrr"}
	mul		factor $tmp62 $tmp63 	%argrw{"wrr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vector_map_range.osl:45
#   else if (range_type == "smootherstep") {
	eq		$tmp64 range_type $const12 	%line{45} %argrw{"wrr"}
	if		$tmp64 151 179 	%argrw{"r"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vector_map_range.osl:46
#     factor = safe_divide((factor - from_min), (from_max - from_min));
...
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vector_map_range.osl:47
#     factor = clamp(factor, 0.0, 1.0);
...
# C:/Users/blender/git/blender-v420/blender.git/lib/windows_x64/osl/share/OSL/shaders/stdosl.h:139
# point  clamp (point x, point minval, point maxval) { return max(min(x,maxval),minval); }
	min		$tmp81 factor $tmp80 	%filename{"C:/Users/blender/git/blender-v420/blender.git/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{139} %argrw{"wrr"}
	max		factor $tmp81 $tmp79 	%argrw{"wrr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vector_map_range.osl:48
#     factor = factor * factor * factor * (factor * (factor * 6.0 - 15.0) + 10.0);
	mul		$tmp82 factor factor 	%filename{"C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vector_map_range.osl"} %line{48} %argrw{"wrr"}
...
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vector_map_range.osl:51
#     factor = safe_divide((factor - from_min), (from_max - from_min));
...
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vector_map_range.osl:53
...
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vector_map_range.osl:54
#   if (use_clamp > 0) {
	gt		$tmp104 use_clamp $const3 	%line{54} %argrw{"wrr"}
	if		$tmp104 235 235 	%argrw{"r"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vector_map_range.osl:55
...
# float  clamp (float x, float minval, float maxval) { return max(min(x,maxval),minval); }
	min		$tmp112 $tmp109 $tmp111 	%filename{"C:/Users/blender/git/blender-v420/blender.git/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{141} %argrw{"wrr"}
	max		$tmp105 $tmp112 $tmp110 	%argrw{"wrr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vector_map_range.osl:56
#                                           clamp(VectorOut.x, to_min.x, to_max.x);
	compref		$tmp113 VectorOut $const3 	%filename{"C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vector_map_range.osl"} %line{56} %argrw{"wrr"}
	compref		$tmp114 to_min $const3 	%argrw{"wrr"}
	compref		$tmp115 to_max $const3 	%argrw{"wrr"}
	functioncall	$const9 200 	%argrw{"r"}
# C:/Users/blender/git/blender-v420/blender.git/lib/windows_x64/osl/share/OSL/shaders/stdosl.h:141
# float  clamp (float x, float minval, float maxval) { return max(min(x,maxval),minval); }
	min		$tmp116 $tmp113 $tmp115 	%filename{"C:/Users/blender/git/blender-v420/blender.git/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{141} %argrw{"wrr"}
	max		$tmp105 $tmp116 $tmp114 	%argrw{"wrr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vector_map_range.osl:55
#     VectorOut.x = (to_min.x > to_max.x) ? clamp(VectorOut.x, to_max.x, to_min.x) :
	compassign	VectorOut $const3 $tmp105 	%filename{"C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vector_map_range.osl"} %line{55} %argrw{"wrr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vector_map_range.osl:57
...
# C:/Users/blender/git/blender-v420/blender.git/lib/windows_x64/osl/share/OSL/shaders/stdosl.h:141
# float  clamp (float x, float minval, float maxval) { return max(min(x,maxval),minval); }
	min		$tmp124 $tmp121 $tmp123 	%filename{"C:/Users/blender/git/blender-v420/blender.git/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{141} %argrw{"wrr"}
	max		$tmp117 $tmp124 $tmp122 	%argrw{"wrr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vector_map_range.osl:58
#                                           clamp(VectorOut.y, to_min.y, to_max.y);
	compref		$tmp125 VectorOut $const5 	%filename{"C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vector_map_range.osl"} %line{58} %argrw{"wrr"}
	compref		$tmp126 to_min $const5 	%argrw{"wrr"}
	compref		$tmp127 to_max $const5 	%argrw{"wrr"}
	functioncall	$const9 217 	%argrw{"r"}
# C:/Users/blender/git/blender-v420/blender.git/lib/windows_x64/osl/share/OSL/shaders/stdosl.h:141
# float  clamp (float x, float minval, float maxval) { return max(min(x,maxval),minval); }
	min		$tmp128 $tmp125 $tmp127 	%filename{"C:/Users/blender/git/blender-v420/blender.git/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{141} %argrw{"wrr"}
	max		$tmp117 $tmp128 $tmp126 	%argrw{"wrr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vector_map_range.osl:57
#     VectorOut.y = (to_min.y > to_max.y) ? clamp(VectorOut.y, to_max.y, to_min.y) :
	compassign	VectorOut $const5 $tmp117 	%filename{"C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vector_map_range.osl"} %line{57} %argrw{"wrr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vector_map_range.osl:59
...
# C:/Users/blender/git/blender-v420/blender.git/lib/windows_x64/osl/share/OSL/shaders/stdosl.h:141
# float  clamp (float x, float minval, float maxval) { return max(min(x,maxval),minval); }
	min		$tmp136 $tmp133 $tmp135 	%filename{"C:/Users/blender/git/blender-v420/blender.git/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{141} %argrw{"wrr"}
	max		$tmp129 $tmp136 $tmp134 	%argrw{"wrr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vector_map_range.osl:60
#                                           clamp(VectorOut.z, to_min.z, to_max.z);
	compref		$tmp137 VectorOut $const6 	%filename{"C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vector_map_range.osl"} %line{60} %argrw{"wrr"}
	compref		$tmp138 to_min $const6 	%argrw{"wrr"}
	compref		$tmp139 to_max $const6 	%argrw{"wrr"}
	functioncall	$const9 234 	%argrw{"r"}
# C:/Users/blender/git/blender-v420/blender.git/lib/windows_x64/osl/share/OSL/shaders/stdosl.h:141
# float  clamp (float x, float minval, float maxval) { return max(min(x,maxval),minval); }
	min		$tmp140 $tmp137 $tmp139 	%filename{"C:/Users/blender/git/blender-v420/blender.git/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{141} %argrw{"wrr"}
	max		$tmp129 $tmp140 $tmp138 	%argrw{"wrr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vector_map_range.osl:59
#     VectorOut.z = (to_min.z > to_max.z) ? clamp(VectorOut.z, to_max.z, to_min.z) :
	compassign	VectorOut $const6 $tmp129 	%filename{"C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_vector_map_range.osl"} %line{59} %argrw{"wrr"}
	end
