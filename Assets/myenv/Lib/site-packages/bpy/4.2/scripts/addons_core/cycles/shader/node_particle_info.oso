...
# options: -q -O2 -IC:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders -IC:/Users/blender/git/blender-v420/blender.git/lib/windows_x64/osl/share/OSL/shaders -o C:/Users/blender/git/blender-v420/build_release/intern/cycles/kernel/osl/shaders/node_particle_info.oso
...
code Velocity
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_particle_info.osl:13
#                           output vector Velocity = point(0.0, 0.0, 0.0),
	assign		Velocity $const1 	%filename{"C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_particle_info.osl"} %line{13} %argrw{"wr"}
code AngularVelocity
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_particle_info.osl:14
#                           output vector AngularVelocity = point(0.0, 0.0, 0.0))
	assign		AngularVelocity $const1 	%filename{"C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_particle_info.osl"} %line{14} %argrw{"wr"}
code ___main___
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_particle_info.osl:16
#   getattribute("particle:index", Index);
	getattribute	$tmp1 $const2 Index 	%filename{"C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_particle_info.osl"} %line{16} %argrw{"wrw"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_particle_info.osl:17
#   getattribute("particle:random", Random);
	getattribute	$tmp2 $const3 Random 	%line{17} %argrw{"wrw"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_particle_info.osl:18
#   getattribute("particle:age", Age);
	getattribute	$tmp3 $const4 Age 	%line{18} %argrw{"wrw"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_particle_info.osl:19
#   getattribute("particle:lifetime", Lifetime);
	getattribute	$tmp4 $const5 Lifetime 	%line{19} %argrw{"wrw"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_particle_info.osl:20
#   getattribute("particle:location", Location);
	getattribute	$tmp5 $const6 Location 	%line{20} %argrw{"wrw"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_particle_info.osl:21
#   getattribute("particle:size", Size);
	getattribute	$tmp6 $const7 Size 	%line{21} %argrw{"wrw"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_particle_info.osl:22
#   getattribute("particle:velocity", Velocity);
	getattribute	$tmp7 $const8 Velocity 	%line{22} %argrw{"wrw"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_particle_info.osl:23
