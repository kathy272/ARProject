...
# options: -q -O2 -IC:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders -IC:/Users/blender/git/blender-v420/blender.git/lib/windows_x64/osl/share/OSL/shaders -o C:/Users/blender/git/blender-v420/build_release/intern/cycles/kernel/osl/shaders/node_brick_texture.oso
...
code Vector
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_brick_texture.osl:68
#                           point Vector = P,
	assign		Vector P 	%filename{"C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_brick_texture.osl"} %line{68} %argrw{"wr"}
code ___main___
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_brick_texture.osl:81
#   point p = Vector;
	assign		p Vector 	%filename{"C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_brick_texture.osl"} %line{81} %argrw{"wr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_brick_texture.osl:83
#   if (use_mapping)
	if		use_mapping 4 4 	%line{83} %argrw{"r"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_brick_texture.osl:84
#     p = transform(mapping, p);
	transform	p mapping p 	%line{84} %argrw{"wrr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_brick_texture.osl:86
#   float tint = 0.0;
	assign		tint $const1 	%line{86} %argrw{"wr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_brick_texture.osl:87
#   color Col = Color1;
	assign		Col Color1 	%line{87} %argrw{"wr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_brick_texture.osl:89
#   Fac = brick(p * Scale,
	mul		$tmp1 p Scale 	%line{89} %argrw{"wrr"}
	functioncall	$const2 80 	%argrw{"r"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_brick_texture.osl:31
#   float offset = 0.0;
	assign		___363_offset $const1 	%line{31} %argrw{"wr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_brick_texture.osl:32
#   float brick_width = BrickWidth;
	assign		___363_brick_width BrickWidth 	%line{32} %argrw{"wr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_brick_texture.osl:35
...
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_brick_texture.osl:37
...
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_brick_texture.osl:38
...
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_brick_texture.osl:39
...
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_brick_texture.osl:42
...
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_brick_texture.osl:44
...
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_brick_texture.osl:45
...
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_brick_texture.osl:47
...
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_brick_texture.osl:12
#   int n = (ns + 1013) & 2147483647;
	add		$tmp25 $tmp24 $const9 	%line{12} %argrw{"wrr"}
	bitand		___362_n $tmp25 $const10 	%argrw{"wrr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_brick_texture.osl:13
#   n = (n >> 13) ^ n;
	shr		$tmp26 ___362_n $const11 	%line{13} %argrw{"wrr"}
	xor		___362_n $tmp26 ___362_n 	%argrw{"wrr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_brick_texture.osl:14
...
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_brick_texture.osl:15
...
# float  clamp (float x, float minval, float maxval) { return max(min(x,maxval),minval); }
	min		$tmp35 $tmp34 $const5 	%filename{"C:/Users/blender/git/blender-v420/blender.git/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{141} %argrw{"wrr"}
	max		tint $tmp35 $const1 	%argrw{"wrr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_brick_texture.osl:49
#   float min_dist = min(min(x, y), min(brick_width - x, row_height - y));
	min		$tmp36 ___363_x ___363_y 	%filename{"C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_brick_texture.osl"} %line{49} %argrw{"wrr"}
...
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_brick_texture.osl:50
#   if (min_dist >= mortar_size) {
	ge		$tmp40 ___363_min_dist MortarSize 	%line{50} %argrw{"wrr"}
	if		$tmp40 72 80 	%argrw{"r"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_brick_texture.osl:51
#     return 0.0;
	assign		Fac $const1 	%line{51} %argrw{"wr"}
	return
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_brick_texture.osl:53
#   else if (mortar_smooth == 0.0) {
	eq		$tmp41 MortarSmooth $const1 	%line{53} %argrw{"wrr"}
	if		$tmp41 76 80 	%argrw{"r"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_brick_texture.osl:54
#     return 1.0;
	assign		Fac $const5 	%line{54} %argrw{"wr"}
	return
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_brick_texture.osl:57
#     min_dist = 1.0 - min_dist / mortar_size;
	div		$tmp42 ___363_min_dist MortarSize 	%line{57} %argrw{"wrr"}
	sub		___363_min_dist $const5 $tmp42 	%argrw{"wrr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_brick_texture.osl:58
#     return smoothstep(0.0, mortar_smooth, min_dist);
	smoothstep	Fac $const1 MortarSmooth ___363_min_dist 	%line{58} %argrw{"wrrr"}
	return
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_brick_texture.osl:101
#   if (Fac != 1.0) {
	neq		$tmp43 Fac $const5 	%line{101} %argrw{"wrr"}
	if		$tmp43 86 86 	%argrw{"r"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_brick_texture.osl:102
#     float facm = 1.0 - tint;
	sub		___368_facm $const5 tint 	%line{102} %argrw{"wrr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_brick_texture.osl:103
...
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_brick_texture.osl:106
