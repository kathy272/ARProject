...
# options: -q -O2 -IC:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders -IC:/Users/blender/git/blender-v420/blender.git/lib/windows_x64/osl/share/OSL/shaders -o C:/Users/blender/git/blender-v420/build_release/intern/cycles/kernel/osl/shaders/node_environment_texture.oso
...
code Vector
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_environment_texture.osl:34
#     vector Vector = P,
	assign		Vector P 	%filename{"C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_environment_texture.osl"} %line{34} %argrw{"wr"}
code ___main___
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_environment_texture.osl:45
#   vector p = Vector;
	assign		p Vector 	%filename{"C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_environment_texture.osl"} %line{45} %argrw{"wr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_environment_texture.osl:47
#   if (use_mapping)
	if		use_mapping 4 4 	%line{47} %argrw{"r"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_environment_texture.osl:48
#     p = transform(mapping, p);
	transformv	p mapping p 	%line{48} %argrw{"wrr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_environment_texture.osl:50
#   p = normalize(p);
	normalize	p p 	%line{50} %argrw{"wr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_environment_texture.osl:52
#   if (projection == "equirectangular")
	eq		$tmp1 projection $const1 	%line{52} %argrw{"wrr"}
	if		$tmp1 26 46 	%argrw{"r"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_environment_texture.osl:53
#     p = environment_texture_direction_to_equirectangular(p);
	functioncall	$const2 26 	%line{53} %argrw{"r"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_environment_texture.osl:10
...
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_environment_texture.osl:11
...
# float hypot (float a, float b) { return sqrt (a*a + b*b); }
	mul		$tmp12 $tmp10 $tmp10 	%filename{"C:/Users/blender/git/blender-v420/blender.git/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{101} %argrw{"wrr"}
	mul		$tmp13 $tmp11 $tmp11 	%argrw{"wrr"}
	add		$tmp14 $tmp12 $tmp13 	%argrw{"wrr"}
	sqrt		$tmp9 $tmp14 	%argrw{"wr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_environment_texture.osl:11
#   float v = atan2(dir[2], hypot(dir[0], dir[1])) / M_PI + 0.5;
	atan2		$tmp7 $tmp8 $tmp9 	%filename{"C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_environment_texture.osl"} %line{11} %argrw{"wrr"}
	div		$tmp15 $tmp7 $const9 	%argrw{"wrr"}
	add		___404_v $tmp15 $const6 	%argrw{"wrr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_environment_texture.osl:13
#   return vector(u, v, 0.0);
	vector		p ___404_u ___404_v $const10 	%line{13} %argrw{"wrrr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_environment_texture.osl:55
#     p = environment_texture_direction_to_mirrorball(p);
	functioncall	$const11 46 	%line{55} %argrw{"r"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_environment_texture.osl:18
#   vector dir = idir;
	assign		___405_dir p 	%line{18} %argrw{"wr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_environment_texture.osl:19
#   dir[1] -= 1.0;
...
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_environment_texture.osl:21
...
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_environment_texture.osl:22
#   if (div > 0.0)
	gt		$tmp22 ___405_div $const10 	%line{22} %argrw{"wrr"}
	if		$tmp22 39 39 	%argrw{"r"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_environment_texture.osl:23
#     dir /= div;
	div		___405_dir ___405_dir ___405_div 	%line{23} %argrw{"wrr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_environment_texture.osl:25
...
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_environment_texture.osl:26
...
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_environment_texture.osl:28
#   return vector(u, v, 0.0);
	vector		p ___405_u ___405_v $const10 	%line{28} %argrw{"wrrr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_environment_texture.osl:59
...
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_environment_texture.osl:58
#   Color = (color)texture(
...
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_environment_texture.osl:61
#   if (ignore_alpha) {
	if		ignore_alpha 52 68 	%line{61} %argrw{"r"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_environment_texture.osl:62
#     Alpha = 1.0;
	assign		Alpha $const12 	%line{62} %argrw{"wr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_environment_texture.osl:64
#   else if (unassociate_alpha) {
	if		unassociate_alpha 68 68 	%line{64} %argrw{"r"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_environment_texture.osl:65
...
#   if (alpha != 1.0 && alpha != 0.0) {
	neq		$tmp30 Alpha $const12 	%filename{"C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders\\node_color.h"} %line{43} %argrw{"wrr"}
...
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_environment_texture.osl:67
#     if (!is_float)
	eq		$tmp34 is_float $const4 	%filename{"C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_environment_texture.osl"} %line{67} %argrw{"wrr"}
	if		$tmp34 68 68 	%argrw{"r"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_environment_texture.osl:68
#       Color = min(Color, 1.0);
	assign		$tmp35 $const12 	%line{68} %argrw{"wr"}
	min		Color Color $tmp35 	%argrw{"wrr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_environment_texture.osl:71
#   if (compress_as_srgb)
	if		compress_as_srgb 110 110 	%line{71} %argrw{"r"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_environment_texture.osl:72
#     Color = color_srgb_to_scene_linear(Color);
	functioncall	$const20 110 	%line{72} %argrw{"r"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders\\node_color.h:29
#   return color(color_srgb_to_scene_linear(c[0]),
	compref		$tmp37 Color $const4 	%filename{"C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders\\node_color.h"} %line{29} %argrw{"wrr"}
