...
# options: -q -O2 -IC:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders -IC:/Users/blender/git/blender-v420/blender.git/lib/windows_x64/osl/share/OSL/shaders -o C:/Users/blender/git/blender-v420/build_release/intern/cycles/kernel/osl/shaders/node_separate_color.oso
...
code ___main___
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_separate_color.osl:15
#   if (color_type == "rgb")
	eq		$tmp1 color_type $const1 	%filename{"C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_separate_color.osl"} %line{15} %argrw{"wrr"}
	if		$tmp1 3 110 	%argrw{"r"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_separate_color.osl:16
#     col = Color;
	assign		col Color 	%line{16} %argrw{"wr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_separate_color.osl:17
#   else if (color_type == "hsv")
	eq		$tmp2 color_type $const2 	%line{17} %argrw{"wrr"}
	if		$tmp2 51 110 	%argrw{"r"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_separate_color.osl:18
...
#   cmax = max(rgb[0], max(rgb[1], rgb[2]));
	compref		$tmp3 Color $const4 	%filename{"C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders\\node_color.h"} %line{85} %argrw{"wrr"}
...
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_separate_color.osl:19
#   else if (color_type == "hsl")
	eq		$tmp28 color_type $const12 	%filename{"C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_separate_color.osl"} %line{19} %argrw{"wrr"}
	if		$tmp28 109 110 	%argrw{"r"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_separate_color.osl:20
#     col = rgb_to_hsl(Color);
	functioncall	$const13 109 	%line{20} %argrw{"r"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders\\node_color.h:177
#   cmax = max(rgb[0], max(rgb[1], rgb[2]));
	compref		$tmp29 Color $const4 	%filename{"C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders\\node_color.h"} %line{177} %argrw{"wrr"}
...
#   return color(h, s, l);
	...
	return
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_separate_color.osl:22
#     warning("%s", "Unknown color space!");
	warning		$const15 $const16 	%filename{"C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_separate_color.osl"} %line{22} %argrw{"rr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_separate_color.osl:24
#   Red = col[0];
	compref		Red col $const4 	%line{24} %argrw{"wrr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_separate_color.osl:25
#   Green = col[1];
	compref		Green col $const5 	%line{25} %argrw{"wrr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_separate_color.osl:26
#   Blue = col[2];
