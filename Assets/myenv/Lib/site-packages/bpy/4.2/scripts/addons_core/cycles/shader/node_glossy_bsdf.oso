...
# options: -q -O2 -IC:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders -IC:/Users/blender/git/blender-v420/blender.git/lib/windows_x64/osl/share/OSL/shaders -o C:/Users/blender/git/blender-v420/build_release/intern/cycles/kernel/osl/shaders/node_glossy_bsdf.oso
...
code Normal
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_glossy_bsdf.osl:13
#                         normal Normal = N,
	assign		Normal N 	%filename{"C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_glossy_bsdf.osl"} %line{13} %argrw{"wr"}
code ___main___
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_glossy_bsdf.osl:18
#   color base_color = max(Color, color(0.0));
	max		base_color Color $const1 	%filename{"C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_glossy_bsdf.osl"} %line{18} %argrw{"wrr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_glossy_bsdf.osl:19
...
# float  clamp (float x, float minval, float maxval) { return max(min(x,maxval),minval); }
	min		$tmp2 Roughness $const3 	%filename{"C:/Users/blender/git/blender-v420/blender.git/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{141} %argrw{"wrr"}
	max		roughness $tmp2 $const2 	%argrw{"wrr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_glossy_bsdf.osl:20
#   roughness = roughness * roughness;
	mul		roughness roughness roughness 	%filename{"C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_glossy_bsdf.osl"} %line{20} %argrw{"wrr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_glossy_bsdf.osl:22
#   float aniso = clamp(Anisotropy, -0.99, 0.99);
	functioncall	$const4 9 	%line{22} %argrw{"r"}
# C:/Users/blender/git/blender-v420/blender.git/lib/windows_x64/osl/share/OSL/shaders/stdosl.h:141
# float  clamp (float x, float minval, float maxval) { return max(min(x,maxval),minval); }
	min		$tmp3 Anisotropy $const6 	%filename{"C:/Users/blender/git/blender-v420/blender.git/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{141} %argrw{"wrr"}
	max		aniso $tmp3 $const5 	%argrw{"wrr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_glossy_bsdf.osl:25
#   vector T = Tangent;
	assign		T Tangent 	%filename{"C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_glossy_bsdf.osl"} %line{25} %argrw{"wr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_glossy_bsdf.osl:27
#   if (abs(aniso) <= 1e-4) {
	abs		$tmp4 aniso 	%line{27} %argrw{"wr"}
	le		$tmp5 $tmp4 $const7 	%argrw{"wrr"}
	if		$tmp5 15 79 	%argrw{"r"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_glossy_bsdf.osl:28
#     roughness_u = roughness;
	assign		roughness_u roughness 	%line{28} %argrw{"wr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_glossy_bsdf.osl:29
#     roughness_v = roughness;
	assign		roughness_v roughness 	%line{29} %argrw{"wr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_glossy_bsdf.osl:32
#     if (Rotation != 0.0)
	neq		$tmp6 Rotation $const2 	%line{32} %argrw{"wrr"}
	if		$tmp6 69 69 	%argrw{"r"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_glossy_bsdf.osl:33
...
#     vector axis = normalize (b - a);
	sub		$tmp9 Normal $const9 	%filename{"C:/Users/blender/git/blender-v420/blender.git/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{270} %argrw{"wrr"}
...
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_glossy_bsdf.osl:35
#     if (aniso < 0.0) {
	lt		$tmp51 aniso $const2 	%filename{"C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_glossy_bsdf.osl"} %line{35} %argrw{"wrr"}
	if		$tmp51 75 79 	%argrw{"r"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_glossy_bsdf.osl:36
#       roughness_u = roughness / (1.0 + aniso);
	add		$tmp52 $const3 aniso 	%line{36} %argrw{"wrr"}
	div		roughness_u roughness $tmp52 	%argrw{"wrr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_glossy_bsdf.osl:37
#       roughness_v = roughness * (1.0 + aniso);
	add		$tmp53 $const3 aniso 	%line{37} %argrw{"wrr"}
	mul		roughness_v roughness $tmp53 	%argrw{"wrr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_glossy_bsdf.osl:40
#       roughness_u = roughness * (1.0 - aniso);
	sub		$tmp54 $const3 aniso 	%line{40} %argrw{"wrr"}
	mul		roughness_u roughness $tmp54 	%argrw{"wrr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_glossy_bsdf.osl:41
#       roughness_v = roughness / (1.0 - aniso);
	sub		$tmp55 $const3 aniso 	%line{41} %argrw{"wrr"}
	div		roughness_v roughness $tmp55 	%argrw{"wrr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_glossy_bsdf.osl:45
#   if (distribution == "Multiscatter GGX")
	eq		$tmp56 distribution $const14 	%line{45} %argrw{"wrr"}
	if		$tmp56 83 85 	%argrw{"r"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_glossy_bsdf.osl:47
...
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_glossy_bsdf.osl:46
#     BSDF = base_color *
	mul		BSDF $tmp57 base_color 	%line{46} %argrw{"wrr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_glossy_bsdf.osl:49
