...
# options: -q -O2 -IC:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders -IC:/Users/blender/git/blender-v420/blender.git/lib/windows_x64/osl/share/OSL/shaders -o C:/Users/blender/git/blender-v420/build_release/intern/cycles/kernel/osl/shaders/node_layer_weight.oso
...
code Normal
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_layer_weight.osl:9
#                          normal Normal = N,
	assign		Normal N 	%filename{"C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_layer_weight.osl"} %line{9} %argrw{"wr"}
code ___main___
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_layer_weight.osl:13
#   float blend = Blend;
	assign		blend Blend 	%filename{"C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_layer_weight.osl"} %line{13} %argrw{"wr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_layer_weight.osl:14
#   float cosi = dot(I, Normal);
	dot		cosi I Normal 	%line{14} %argrw{"wrr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_layer_weight.osl:17
#   float eta = max(1.0 - Blend, 1e-5);
	sub		$tmp1 $const1 Blend 	%line{17} %argrw{"wrr"}
	max		eta $tmp1 $const2 	%argrw{"wrr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_layer_weight.osl:18
#   eta = backfacing() ? eta : 1.0 / eta;
	backfacing	$tmp2 	%line{18} %argrw{"w"}
	if		$tmp2 7 8 	%argrw{"r"}
	div		eta $const1 eta 	%argrw{"wrr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_layer_weight.osl:19
...
#   float c = fabs(cosi);
	fabs		___344_c cosi 	%filename{"C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders\\node_fresnel.h"} %line{12} %argrw{"wr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders\\node_fresnel.h:13
...
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_layer_weight.osl:22
#   Facing = fabs(cosi);
	fabs		Facing cosi 	%filename{"C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_layer_weight.osl"} %line{22} %argrw{"wr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_layer_weight.osl:24
#   if (blend != 0.5) {
	neq		$tmp19 blend $const6 	%line{24} %argrw{"wrr"}
	if		$tmp19 46 46 	%argrw{"r"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_layer_weight.osl:25
...
# float  clamp (float x, float minval, float maxval) { return max(min(x,maxval),minval); }
	min		$tmp20 blend $const8 	%filename{"C:/Users/blender/git/blender-v420/blender.git/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{141} %argrw{"wrr"}
	max		blend $tmp20 $const7 	%argrw{"wrr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_layer_weight.osl:26
#     blend = (blend < 0.5) ? 2.0 * blend : 0.5 / (1.0 - blend);
	lt		$tmp21 blend $const6 	%filename{"C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_layer_weight.osl"} %line{26} %argrw{"wrr"}
	if		$tmp21 43 45 	%argrw{"r"}
	mul		blend $const10 blend 	%argrw{"wrr"}
	sub		$tmp22 $const1 blend 	%argrw{"wrr"}
	div		blend $const6 $tmp22 	%argrw{"wrr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_layer_weight.osl:28
#     Facing = pow(Facing, blend);
	pow		Facing Facing blend 	%line{28} %argrw{"wrr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_layer_weight.osl:31
#   Facing = 1.0 - Facing;
