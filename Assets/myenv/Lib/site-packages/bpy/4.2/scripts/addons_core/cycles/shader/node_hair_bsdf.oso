...
# options: -q -O2 -IC:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders -IC:/Users/blender/git/blender-v420/blender.git/lib/windows_x64/osl/share/OSL/shaders -o C:/Users/blender/git/blender-v420/build_release/intern/cycles/kernel/osl/shaders/node_hair_bsdf.oso
...
code ___main___
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_hair_bsdf.osl:15
#   float roughnessh = clamp(RoughnessU, 0.001, 1.0);
	functioncall	$const3 3 	%filename{"C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_hair_bsdf.osl"} %line{15} %argrw{"r"}
# C:/Users/blender/git/blender-v420/blender.git/lib/windows_x64/osl/share/OSL/shaders/stdosl.h:141
# float  clamp (float x, float minval, float maxval) { return max(min(x,maxval),minval); }
	min		$tmp1 RoughnessU $const2 	%filename{"C:/Users/blender/git/blender-v420/blender.git/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{141} %argrw{"wrr"}
	max		roughnessh $tmp1 $const1 	%argrw{"wrr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_hair_bsdf.osl:16
#   float roughnessv = clamp(RoughnessV, 0.001, 1.0);
	functioncall	$const3 6 	%filename{"C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_hair_bsdf.osl"} %line{16} %argrw{"r"}
# C:/Users/blender/git/blender-v420/blender.git/lib/windows_x64/osl/share/OSL/shaders/stdosl.h:141
# float  clamp (float x, float minval, float maxval) { return max(min(x,maxval),minval); }
	min		$tmp2 RoughnessV $const2 	%filename{"C:/Users/blender/git/blender-v420/blender.git/lib/windows_x64/osl/share/OSL/shaders/stdosl.h"} %line{141} %argrw{"wrr"}
	max		roughnessv $tmp2 $const1 	%argrw{"wrr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_hair_bsdf.osl:17
#   float offset = -Offset;
	neg		offset Offset 	%filename{"C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_hair_bsdf.osl"} %line{17} %argrw{"wr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_hair_bsdf.osl:20
#   float IsCurve = 0;
	assign		IsCurve $const4 	%line{20} %argrw{"wr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_hair_bsdf.osl:21
#   getattribute("geom:is_curve", IsCurve);
	getattribute	$tmp3 $const5 IsCurve 	%line{21} %argrw{"wrw"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_hair_bsdf.osl:23
#   if (isconnected(Tangent)) {
	isconnected	$tmp4 Tangent 	%line{23} %argrw{"wr"}
	if		$tmp4 12 17 	%argrw{"r"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_hair_bsdf.osl:24
#     T = Tangent;
	assign		T Tangent 	%line{24} %argrw{"wr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_hair_bsdf.osl:26
#   else if (!IsCurve) {
	eq		$tmp5 IsCurve $const6 	%line{26} %argrw{"wrr"}
	if		$tmp5 16 17 	%argrw{"r"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_hair_bsdf.osl:27
#     T = normalize(dPdv);
	normalize	T dPdv 	%line{27} %argrw{"wr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_hair_bsdf.osl:28
#     offset = 0.0;
	assign		offset $const6 	%line{28} %argrw{"wr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_hair_bsdf.osl:31
#     T = normalize(dPdu);
	normalize	T dPdu 	%line{31} %argrw{"wr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_hair_bsdf.osl:34
...
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_hair_bsdf.osl:35
#     BSDF = transparent();
	closure		BSDF $const7 	%line{35} %argrw{"wr"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_hair_bsdf.osl:38
#     if (component == "reflection")
	eq		$tmp9 component $const8 	%line{38} %argrw{"wrr"}
	if		$tmp9 28 30 	%argrw{"r"}
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_hair_bsdf.osl:39
...
# C:/Users/blender/git/blender-v420/blender.git/intern/cycles/kernel/osl/shaders/node_hair_bsdf.osl:41
